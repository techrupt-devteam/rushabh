          ...
          <div class="row">
              ...
              <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="text" tabindex="1" name="name" class="form-control" autocomplete="off" placeholder="Customer Name" required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="text" tabindex="8" name="contact_to" class="form-control" autocomplete="off" placeholder="Contact to">
                  </div>
                </div>
              </div>
