  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="col-12">
      <div class="panel panel-default">
        <div class="panel-heading"> Add Offers
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <a href="<?php echo site_url('admin/offers');?>" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" data-original-title="Back">
                    <i class="la la-arrow-left icon"></i>
                   </a>
                  </div>
            </div>
        </div>
        <div class="panel-body">
          <div class="row">
              ...
              <div class="col-xl-8">
                ...
                <div class="mb-12">
                  <div id="image-preview" style="background-size:cover;background-image: url('dist/images/default-img.jpg');width: 100%;height: 300px;">
