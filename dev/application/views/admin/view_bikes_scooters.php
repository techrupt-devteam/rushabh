          ...
          <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php $cnt=''; foreach($slider_list as $row): $cnt++; ?>
                   ...
                   <td>
                    <a href="<?php echo base_url(); ?>admin/manage_slider/delete/<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this record ?');" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete Slide"><i class="la la-trash icon"></i></a>
                  </td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
