        ...
        <div class="panel-body" style="padding-left: 7px;">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content overflow">
              <?php //print_r($body_dimensions_data['image_title']); die; 
        ...
        <div class="modal-body">
            <div class="col-md-6">
              <label class="control-label"> List<span style="color: red;">*</span></label>
               <div class="">
                <input type="text" id="bodydimensionname" name="list" class="form-control">
              </div>
            </div>
            <div class="col-md-6">
              <label class="control-label"> Details<span style="color: red;">*</span></label>
               <div class="">
                <input type="text" id="bodydimensiondetails" name="details" class="form-control">
              </div>
            </div>
