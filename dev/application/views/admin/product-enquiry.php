<?php    $title="Product Enquiry | Rushabh Honda";	?><?php  $pgDesc="Product Enquiry of Rushabh Honda Nashik"; $pgKeywords="Product Enquiry of Rushabh Honda Nashik"; include 'header.php'; ?>  
...
<main>
  ...
  <div class="container-fluid innerpage">
    <div class="container">
       ...
       <fieldset class="form-book mt-4">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-2">
             <label>Your Name <span class="parsley-required">*</span></label>
          ...
          <div class="col-md-12 col-lg-8 mb-2">
            ...
            <textarea style="max-width: 100%;" class="form-control" cols="20" id="Remarks"  name="Remarks" rows="3"></textarea>
          </div>
          <div class="col-md-12 col-lg-8 mb-2">
      ...
      <div class="mt-3 mb-4">
            <button id="submit" type="submit" data-loading-text="Submitting..." autocomplete="off" class="btn redbutton">Submit</button>
          </div>
       </form>
    </div>
  </div>
