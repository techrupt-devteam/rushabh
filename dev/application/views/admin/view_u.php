      ...
      <div class="panel panel-default">
        <div class="panel-heading"> Inbond Calls - Uttam Nagar
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <strong><a href="<?php echo site_url('admin/inbond_callsu/add_u');?>" class="btn btn-info pull-right"><i class="la la-plus icon"></i></a></strong>
                  </div>
            </div>
        </div>
                 ...
                 <?php $cnt=''; foreach($inbond_calls_list as $row): $cnt++; ?>
                  <tr ><!-- data-href="add-party.php" class="cursor-pointer" -->
                   ...
                   <td>
                    ...
                    <a href="<?php echo base_url(); ?>admin/inbond_callsu/view_info/<?php echo $row['id'] ?>"  class="btn btn-default"><i class="la la-table icon"></i></a>
                    <a href="<?php echo base_url(); ?>admin/inbond_callsu/delete/<?php echo $row['id'] ?>" class="btn btn-default" onclick="return confirm('Are you sure to delete this record ?');"><i class="la la-trash icon"></i></a>
                  </td>  
