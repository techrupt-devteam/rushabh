      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="row">
              ...
              <div class="">
                <input type="text" name="price" class="form-control" autocomplete="off" placeholder="Please enter price" required="required">
              </div>
            </div>
          ...
          <div class="row">
           <div class="col-sm-6 col-xl-6 col-md-6">
              ...
              <div class="">
                <input type="file" name="banner_image" class="form-control" autocomplete="off" required="required">
              </div>
            </div>
          </div>
