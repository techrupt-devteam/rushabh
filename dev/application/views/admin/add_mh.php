...
<div class="col-md-12">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Add Inbond calls - Mhasrul</li>
    </ol>
  </div>
</div>
  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="col-12">
      <div class="panel panel-default">
        <div class="panel-heading"> Add Inbond calls - Mhasrul
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <a href="<?php echo site_url('admin/inbond_callsmh');?>" class="btn btn-info pull-right"><strong><i class="la la-arrow-right icon"></i></strong></a>
                  </div>
            </div>
        </div>
