...
<main>
    <div class="bg-fixed breadcrumb-area dark padding-xl shadow text-center text-light" style="background-image: url(assets/images/Finance.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 text-md-left"><h1>Online Booking</h1></div>
    ...
    <div class="container innerpage">
        <div class="contact-form my-5">
            <div class="formsection">
                <form action="" data-parsley-validate="parsley" enctype="multipart/form-data" method="post" role="form">
                    <fieldset class="form-book">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Mobile No.</label><span class="text-danger parsley-required">*</span>
                                <input
                                    class="form-control"
                                    id="inputAddress2"
                                    name="mobile"
                            ...
                            <div class="mb-2 col-lg-8 col-md-12">
                                <label for="inputAddress2">Address</label><span class="text-danger parsley-required">*</span>
                                <textarea aria-label="With textarea" class="form-control" name="address" rows="1" data-parsley-errors-container="#error_address" placeholder="Enter Your Address" required></textarea>
                                <span class="text-danger parsley-required" id="error_address"></span>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2 col-lg-4">
                                ...
                                <select class="form-control" name="car" required aria-invalid="false" aria-required="true" id="car" onchange="function_car()">
                                    ...
                                    <option value="<?php echo $row->car; ?>">HONDA<?php echo $row->car; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Bike & Scooter Variant</label><span class="text-danger parsley-required">*</span>
                                <select class="form-control" name="varient" required aria-invalid="false" aria-required="true" id="varient" onchange="function_varient()">
                                    <option value="">Select Variant</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Color</label><span class="text-danger parsley-required">*</span>
                                <select class="form-control" name="color" required aria-invalid="false" aria-required="true" id="__color" onchange="function_color()">
                                    <option value="">Select Color</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Our Showroom<span class="text-danger parsley-required">*</span></label>
                            ...
                            <div class="col-md-6 mb-2 col-lg-4"><label for="inputAddress2">Any Special Request</label><textarea aria-label="With textarea" class="form-control" name="special_request" rows="1"></textarea></div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">On Road Cost</label><br />
                                <i class="fa-rupee-sign fas"></i> <span id="roadprice_span">0.00 </span><input class="form-control" id="roadprice" name="roadprice" required placeholder="On Road Cost" type="hidden" />
                            </div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Do you Require Finance</label><span class="text-danger parsley-required">*</span>
                                <div>
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input class="custom-control-input" id="customRadioInline1" name="finance" required type="radio" data-parsley-errors-container="#error_finance" value="Yes" />
                                        <label for="customRadioInline1" class="custom-control-label">Yes</label>
                                    </div>
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input class="custom-control-input" id="customRadioInline2" name="finance" required type="radio" value="No" /><label for="customRadioInline2" class="custom-control-label">No</label>
                                    </div>
                                    <span class="text-danger parsley-required" id="error_finance"></span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2 col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input class="custom-file-input" id="adhar_cart" name="adhar_cart" type="file" data-parsley-errors-container="#error_adhar" onchange="function_adhar_cart()" />
                                        <label for="adhar_cart" class="custom-file-label">Choose file</label>
                                    </div>
                                </div>
                                <span class="text-danger parsley-required" id="error_adhar"></span>
                            </div>
                            <div class="col-md-6 mb-2 col-lg-4">
                                <label for="inputAddress2">Pan Card</label>
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input class="custom-file-input" id="pan_card" name="pan_card" type="file" data-parsley-errors-container="#error_pancard" onchange="function_pan_card()" />
                                        <label for="pan_card" class="custom-file-label">Choose file</label>
                                    </div>
                                </div>
                                <span class="text-danger parsley-required" id="error_pancard"></span>
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label for="exampleCheck1" class="custom-control-label">I Agree With "RUSHABH HONDA.<span class="text-danger">*</span></label><a href="terms-conditions.php" style="color: #fff;">Terms and Conditions.</a>
                                </div>
