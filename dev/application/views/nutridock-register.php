        ...
        <div class="col-eight pricing-table">
          <h1 class="intro-header aos-init aos-animate" data-aos="fade-up">Our Webinar</h1>
           <!-- <form id="web_order_summery_form" action="<?php echo base_url(); ?>/nutridock_payment/capture_payment" method="post"> -->
            ...
            <small id="err_mobile" style="color:red;"></small>
...
if (pattern.test(mobile_value)==false) {
  ...
  jQuery.ajax({
    type: "POST",
    url: "<?php echo base_url(); ?>nutridock_register/checkout",
    //dataType: 'html',
    ...
    success: function(res) 
    {
      ...
      window.location.href = "<?php echo base_url(); ?>nutridock_register/capture_payment";
      }
      else
      {
