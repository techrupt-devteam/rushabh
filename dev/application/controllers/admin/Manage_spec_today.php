...
function __construct(){
	...
	public function index()
	{
		...
		/*$data['body_dimensions_data'] = $this->db->query("select * from specifications_demo WHERE bike_scooter_id='".$id."' AND type='Body Dimensions' group by '".$id."'")->result();*/
		$data['body_dimensions_data'] = $this->common->getOneRow('specifications_demo',"WHERE bike_scooter_id='".$id."' AND type='Body Dimensions' group by '".$id."'");

		$data['engine'] = $this->common->getAllRow('specifications_demo',"WHERE bike_scooter_id='".$id."' AND type='Engine' order by id asc");
		//$data['engine_data'] = $this->common->getOneRow('specifications_demo',"WHERE bike_scooter_id='".$id."' AND type='Body Dimensions' group by '".$id."'");
	...
	if($this->input->post('update_bodydimension'))
	{
		...
		$this->common->updateRecord('specifications_demo',$data_in,"id = ". $id);
		print '<script>alert("Record added successfully");
		window.location.href = "'.base_url().'admin/manage_specification_details/'.$bikes_scooters_id.'";
		</script>';
	}
	...
	if($this->input->post('submit_engine'))
	{
		...
		//$this->db->where('id',$bikesid[$i])->update('specifications_demo',$data);
		print '<script>alert("Record added successfully");
			window.location.href = "'.base_url().'admin/manage_specification_details/'.$id.'";
			</script>';
		}		
	}
