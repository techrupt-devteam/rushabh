...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    <td>Hornet 2.0 Repsol Honda Edition</td>
      <td>-</td>
    <td><strong>1,56,822/-</strong></td>
  </tr>
...
<p class="notice">* Prices are subject to change without any prior notice.</p>
        ...
        <div class="col-md-6 text-center"> <img src="assets/images/hornet2-0/MatTE-Axis-Grey-Metallic.png" title="Hornet on road price in Nashik | Grey | Rushabh Honda" alt="Checkout Grey Honda Hornet 2.0 specifications, price, and more easily online. Available Honda Two wheeler at reasonable prices exclusively at Rushabh Honda."></div>
      </div>
    </div>
    <!--Site About Section--> 
    <!--Specification-->
    <div class="site-specification">
      ...
      <div class="row">
        <div class="col-md-5"> <img src="assets/images/hornet2-0/Spec_bike.png" title="Hornet price in nashik | Specifications | Rushabh Honda" alt="Checkout Honda Hornet 2.0 specifications, price, colors and more easily online. Available Honda Two wheeler at reasonable prices exclusively at Rushabh Honda."> </div>
        <div class="col-md-7">
        ...
        <div class="row">
          <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade text-center" id="hornet-repsol" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <img src="assets/images/hornet2-0/repsol.png" title="Hornet on road price in Nashik | Black | Rushabh Honda" alt="Checkout Black Honda Hornet 2.0 specifications, price, and more easily online. Available Honda Two wheeler at reasonable prices exclusively at Rushabh Honda.">
              </div>
          ...
          <div class="color-section">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
             ...
             <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-metallic" role="tab" aria-controls="v-pills-messages" aria-selected="false">
             	...
             	<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-metallic-black" role="tab" aria-controls="v-pills-messages" aria-selected="false"><span><img src="assets/images/hornet2-0/Pearl-Igneous-Black.jpg"  title="Hornet on road price in Nashik | Black | Rushabh Honda" alt="Checkout Black Honda Hornet 2.0 specifications, price, and more easily online. Available Honda Two wheeler at reasonable prices exclusively at Rushabh Honda."></span><abbr>Pearl Igneous Black</abbr></a>
             	<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#hornet-repsol" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                <span><img src="assets/images/hornet2-0/Repsol-thumb.jpg"  title="Hornet on road price in Nashik | Black | Rushabh Honda" alt="Checkout Black Honda Hornet 2.0 specifications, price, and more easily online. Available Honda Two wheeler at reasonable prices exclusively at Rushabh Honda."></span><abbr>Hornet 2.0 Repsol Honda Edition</abbr></a>
             </div>
          </div>
        </div>
      </div>
