    ...
    <div class="innerpage">
        ...
        <div class="about-product">
            ...
            <div class="row">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Striking Green</td>
                                        <td><strong>98085</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Imperial Red Metallic</td>
                                        <td><strong>98085</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Pearl Siren Blue</td>
                                        <td><strong>98085</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Matte Axis Grey Mettalic</td>
                                        <td><strong>98085</strong></td>
                                    </tr>
                                    <tr>
                                        <td>SP125 DRUM CBS-BSVI</td>
                                        <td>Striking Green</td>
                                        <td><strong>93065</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Imperial Red Metallic</td>
                ...
                <div class="col-md-6 text-center"><img src="assets/images/sp-125bs-vi/matte-grey.png" class="resposive-img"   /></div>
            </div>
        </div>
        <div class="site-specification">
            ...
            <div class="row">
                ...
                <div class="col-md-5"><img src="assets/images/sp-125bs-vi/pearl-siren-blue.png" class="resposive-img" /></div>
                <div class="col-md-7">
