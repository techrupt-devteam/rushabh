...
<style>
  ...
  <div class="innerpage">
    <div class="main-product-banner">
    	<img src="assets/images/activa6g/activa-banner.jpg"s class="resposive-img" title="Honda Activa 6G | Blue | Rushabh Honda" alt="Checkout Blue Honda Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years.">
    </div>
        ...
        <div class="col-md-12">
          <div class="about-left">
           ...
           <div class="col-md-6">
            ...
            <p class="notice mt-3">* Prices are subject to change without any prior notice.
            </p>
            <a href="<?php echo base_url(); ?>online-booking" class="btn btn-lg btn-danger d-block mx-auto mb-5" style="max-width:170px">Book Now</a>
           </div>
          <div class="col-md-6 text-center">
          <img src="assets/images/activa6g/01Blue.png" title="Honda Activa 6G | Blue | About | Rushabh Honda" alt="Checkout Blue Metallic Honda Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years.">
        </div>
    </div>
  </div>
  <div class="site-specification">
    ...
    <div class="row">
      <div class="col-md-5"><img src="assets/images/activa6g/Specimg.png" class="resposive-img" title="Honda Activa 6G | Blue | Rushabh Honda" alt="Checkout Blue Honda Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years.">
            
            <a href="<?php echo base_url(); ?>online-booking" class="btn btn-lg btn-danger d-md-block d-none" style="max-width:170px">Book Now
            </a>
      </div>
      <div class="col-md-7">
  ...
  <div class="bike-color">
    ...
    <div class="bd-example bd-example-tabs">
      <div class="row">
        <div class="col-9">
          <div class="tab-content"id="v-pills-tabContent">
            ...
            <div class="fade tab-pane text-center"id="v-pills-yellow1"role="tabpanel"aria-labelledby="v-pills-settings-tab">
             ...
             <!--<div class="fade tab-pane text-center"id="v-pills-gold"role="tabpanel"aria-labelledby="v-pills-settings-tab">
            	<img src="assets/images/activa6g/Pearl-Night-Star-Black.png" title="Honda Activa 6G | Gold | Rushabh Honda" alt="99">
            </div>-->
            
            <!--<div class="fade tab-pane text-center"id="v-pills-yellow1"role="tabpanel"aria-labelledby="v-pills-settings-tab">
            	<img src="assets/images/activa6g/Pearl-Night-Star-Black.png" title="Honda Activa 6G | Grey | Rushabh Honda" alt="Checkout Pearl Night Star Black Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years.">
            </div>-->
        ...
        <div class="color-section position-relative">
          ...
          <img src="assets/images/activa6g/01Blue.png" title="Honda Activa 6G | Glitter Blue Metallic | Rushabh Honda" alt="Checkout Glitter Blue Metallic Honda Activa 6G at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."></span><abbr>Glitter Blue Metallic</abbr></a> <a href="#v-pills-silver"data-toggle="pill"aria-controls="v-pills-profile"aria-selected="false"role="tab"class="nav-link"id="v-pills-profile-tab"><span>
          <img src="assets/images/activa6g/02-red.png" title="Honda Activa 6G | Pearl Spartan Red | Rushabh Honda" alt="Checkout Pearl Spartan Red Honda Activa 6G at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years. Click for more!"></span><abbr>Pearl Spartan Red</abbr></a> <a href="#v-pills-metallic"data-toggle="pill"aria-controls="v-pills-messages"aria-selected="false"role="tab"class="nav-link"id="v-pills-messages-tab"><span>
          ...
          <img src="assets/images/activa6g/05-white.png" title="Honda Activa 6G | White | Rushabh Honda" alt="Checkout white Metallic Honda Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."> </span><abbr>Pearl Precious White</abbr></a> 
          <a href="#v-pills-yellow1"data-toggle="pill"aria-controls="v-pills-settings"aria-selected="false"role="tab"class="nav-link"id="v-pills-settings-tab"><span>
          <img src="assets/images/activa6g/06-Grey.png"  title="Honda Activa 6G | Grey | Rushabh Honda" alt="Checkout Matte Grey Honda Activa 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."> 
          </span><abbr>Matte Axis Grey Metallic</abbr></a>
          
          
          
           <!--<a href="#v-pills-gold"data-toggle="pill"aria-controls="v-pills-settings"aria-selected="false"role="tab"class="nav-link"id="v-pills-settings-tab"><span>
          <img src="assets/images/activa6g/Pearl-Night-Star-Black.png"  title="Honda Activa 6G | Gold | Rushabh Honda" alt="99"> 
          </span><abbr>Pearl Night Star Black</abbr></a>-->
          
          
          <!--<a href="#v-pills-yellow1"data-toggle="pill"aria-controls="v-pills-settings"aria-selected="false"role="tab"class="nav-link"id="v-pills-settings-tab"><span>
          <img src="assets/images/activa6g/Pearl-Night-Star-Black.png"  title="Honda Activa 6G | Grey | Rushabh Honda" alt="Checkout Pearl Night Star Blacka 6G features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."> 
          </span><abbr>Pearl Night Star Black</abbr></a>-->
          </div>
          
          <div class="position-absolute request-call-back" style="bottom: 0;">
              <a href="<?php echo base_url(); ?>contact-us" class="btn btn-lg btn-outline-danger d-block" style="max-width:300px;border-width: 2px;border-radius: 0;margin-bottom: -76px;">Request A Callback 
            </a>
          </div>
        </div>
      </div>
