  ...
  <div class="innerpage">
    ...
    <div class="about-product">
      <div class="row">
        ...
        <div class="text-center col-md-6"><img src="assets/images/unicorn/aboutme-unicorn.png" title="Honda CB Unicorn | Grey | Rushabh Honda" alt="Checkout Grey Honda CB Unicorn features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years. Click for more!"></div>
      </div>
    </div>
    <div class="site-specification">
      ...
      <div class="row">
        <div class="col-md-5">
        	<img src="assets/images/unicorn/specification.png" title="Honda CB Unicorn | Red | Specification | Rushabh Honda" alt="Checkout Red Honda CB Unicorn specifications, features, price and more exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."></div>
        <div class="col-md-7">
          ...
          <div class="tab-content"id="pills-tabContent">
            ...
            <p class="note">*The specifications and design of the motorcycle shown may vary according to requirements & conditions and are subject to change without any notice. Accessories shown in the picture are not a part of the standard equipment.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bd-example bd-example-tabs">
        <div class="row">
          ...
          <div class="color-section">
            <div class="nav nav-pills flex-column"id="v-pills-tab"role="tablist"aria-orientation="vertical"><a aria-controls="v-pills-home"aria-selected="true"class="nav-link active show"data-toggle="pill"href="#v-pills-red"id="v-pills-home-tab"role="tab"><span>
            <img src="assets/images/unicorn/Pearl-Igneous-Black.png" title="Honda CB Unicorn | Pearl Igneous Black | Rushabh Honda" alt="Available Pearl Igneous Black Honda CB Unicorn at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years.">
            </span><abbr>Pearl Igneous Black</abbr></a> <a aria-controls="v-pills-profile"aria-selected="false"class="nav-link"data-toggle="pill"href="#v-pills-silver"id="v-pills-profile-tab"role="tab"><span>
            <img src="assets/images/unicorn/Red.png" title="Honda CB Unicorn | Red Colour | Rushabh Honda" alt="Available Red Honda CB Unicorn at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years. Click for more info!">
            </span><abbr>Red</abbr></a> <a aria-controls="v-pills-messages"aria-selected="false"class="nav-link"data-toggle="pill"href="#v-pills-metallic"id="v-pills-messages-tab"role="tab"><span>
