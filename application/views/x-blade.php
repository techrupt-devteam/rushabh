  ...
  <div class="innerpage">
    ...
    <div class="about-product">
      <div class="row">
        ...
        <div class="col-md-6 text-center"><img src="assets/images/x-blade/pearl-spartan-red.png" class="resposive-img" title="Honda X Blade | Pearl Spartan Red | Rushabh Honda" alt="Available Pearl Spartan Red Honda X Blade at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."></div>
      </div>
    </div>
    <div class="site-specification">
      <h2>Specifications*</h2>
      <div class="row">
        <div class="col-md-5"><img src="assets/images/x-blade/pearl-igneous-black.png" class="resposive-img" title="Honda X Blade | Pearl Igneous Black | Rushabh Honda" alt="Available Pearl Igneous Black Honda X Blade at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."></div>
        <div class="col-md-7">
      ...
      <div class="bd-example bd-example-tabs">
        <div class="row">
          ...
          <div class="color-section">
            ...
            <img src="assets/images/x-blade/pearl-spartan-red.png" title="Honda X Blade | Pearl Spartan Red | Rushabh Honda" alt="Available Pearl Spartan Red Honda X Blade at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."></span><abbr>Pearl Spartan Red</abbr> </a><a href="#v-pills-silver"data-toggle="pill"aria-controls="v-pills-profile"aria-selected="false"role="tab"class="nav-link"id="v-pills-profile-tab"><span>
            <img src="assets/images/x-blade/pearl-igneous-black.png" title="Honda X Blade | Pearl Igneous Black | Rushabh Honda" alt="Available Pearl Igneous Black Honda X Blade at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."> </span><abbr>Pearl Igneous Black</abbr> </a><a href="#v-pills-metallic"data-toggle="pill"aria-controls="v-pills-messages"aria-selected="false"role="tab"class="nav-link"id="v-pills-messages-tab"><span>
            <img src="assets/images/x-blade/Matte-Axis-Grey-Metallic.png" title="Honda X Blade | Matte Axis Grey Metallic | Rushabh Honda" alt="Available Matte Axis Grey Metallic Honda X Blade at reasonable price exclusively at Rushabh Honda, Nashik. Best Two wheeler Honda Dealers for years."> </span><abbr>Matte AXIS GreY Metallic </abbr></a><a href="#v-pills-blue"data-toggle="pill"aria-controls="v-pills-settings"aria-selected="false"role="tab"class="nav-link"id="v-pills-settings-tab"><span>
