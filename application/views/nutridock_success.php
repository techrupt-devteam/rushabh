...
<header id="header" style="position:relative">
  <div class="row" style="position: relative;">
    <div class="header-logo"> <a href="<?php echo base_url(); ?>">Nutridock</a> </div>
...
<main id="main">
  <section style="padding-bottom: 0px;">
    <div class="container" style="margin: 0px 15px;">
      <div class="section-title" style="max-width: 626px;margin: 0px auto;">
        <!--<h2>Congratulations !! </h2>
        <h5>Payment Successful.Check your email for webinar confirmation and details.</h5>-->
        <img src="<?php echo base_url(); ?>assets/landing/images/congratulation.png" class="img-fluid" style="box-shadow: 0px 1px 8px #222;"/>
      </div>
    </div>
  </section>
</main>
...
<!-- footer
    ================================================== -->
<section class="page-section" id="contact" style="padding-top: 4rem;">
  <div class="container">
