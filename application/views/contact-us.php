...
Mumbai Naka,
Nasik</p></div></div></div><div class="col-lg-3 col-sm-6 mb-grid-gutter"><div class="border-0 box-shadow-lg card h-100"><div class="text-center card-body"><i class="mb-3 fas fa-clock text-danger"style="font-size:2.25rem"></i><h3 class="mb-2 h6">Working hours</h3><ul class="font-size-sm list-unstyled mb-0"><li>Mon - Fri: 10AM - 5PM</li><li>Sat: 10AM - 5PM</li></ul></div></div></div><div class="col-lg-3 col-sm-6 mb-grid-gutter"><div class="border-0 box-shadow-lg card h-100"><div class="text-center card-body"><i class="mb-3 fas fa-phone-alt text-info"style="font-size:2.25rem"></i><h3 class="mb-2 h6">Phone numbers</h3><ul class="font-size-sm list-unstyled mb-0"><li><span class="mr-1">Enquiry :</span><a href="tel:+91 88888 77649"class="nav-link-style">+91 88888 77649</a></li></ul></div></div></div><div class="col-lg-3 col-sm-6 mb-grid-gutter">
    <div class="border-0 box-shadow-lg card h-100"><div class="text-center card-body"><h3 class="mb-2 h6">Email addresses</h3><ul class="font-size-sm list-unstyled mb-0"><li>
        <span class="mr-1">Customer service:</span><a href="mailto:enquiry@rushabh2w.com"class="nav-link-style">enquiry@rushabh2w.com</a></li><li><span class="mr-1">Tech support:</span>
        <a href="mailto:support@example.com"class="nav-link-style">it@sevagroup.co.in</a></li></ul></div></div></div></div></section><section class="border-top"id="map">
            <div class="row cs-gallery no-gutters"lg-uid="lg0"><div class="col-lg-6 px-3 px-lg-5"><div class="contact-form mb-1 mt-1"><h2>Contact Us</h2>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control" data-parsley-required-message="Please Enter Email ID"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" id="Email" name="email_id"placeholder="Email"style="max-width:100%"data-parsley-type="email"data-parsley-type-message="Enter Valid Email id(abc@gmail.com)"></div>
                                            </div><div id="err_email" style="color: red;"></div>
                                            </div><div class="form-group"><div class="row"><div class="col-md-12"><label>Your Address <span style="color:red">*</span></label></div><div class="col-md-12">
