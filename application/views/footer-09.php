            ...
            <div class="col-lg-7 col-md-12">
                <div class="newsletter_form">
                    <form action="" method="post">
                        ...
                        <button type="submit" name="subscription_submit" value="subscription_submit">Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <ul class="row">
            <li class="col-md-12 mt-2">
              ...
              <div class="ginput_container">
                  <input type="text" name="name" class="large" maxlength="150" autocomplete="off">
            ...
            <li class="col-6 col-md-12 mt-2">
              ...
              <div class="ginput_container">
                <input type="text" name="mobile" class="input-message" autocomplete="off" maxlength="10"> 
            ...
            <li class="col-6 col-md-12 mt-2">
              ...
              <div class="ginput_container">
                <input type="text" name="address" class="input-message" autocomplete="off" maxlength="10"> 
                  <span style="color: red" id="error_message"></span>
              </div>
            </li>
