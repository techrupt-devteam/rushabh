...
<div class="col-md-12">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Edit system data</li>
    </ol>
  </div>
</div>
  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="col-12">
      <div class="panel panel-default">
        <div class="panel-heading"> Edit system data
          ...
          <div class="row">
              ...
              <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="text" tabindex="1" value="<?php echo $system_data['name'] ?>" name="name" class="form-control" autocomplete="off" placeholder="Customer Name">
                  </div>
                </div>
              </div>
               ...
               <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="text" value="<?php echo $system_data['enquiry_no'] ?>" tabindex="2" name="enquiry_no" class="form-control" autocomplete="off" placeholder="Enquiry no">
                  </div>
                </div>
              </div>
