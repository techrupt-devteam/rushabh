      ...
      <div class="panel panel-default">
        <div class="panel-heading"> Add Inbond calls
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <a href="<?php echo site_url('admin/inbond_callsm');?>" class="btn btn-info pull-right"><strong><i class="la la-arrow-right icon"></i></strong></a>
                  </div>
            </div>
        </div>
          ...
          <div class="row">
              ...
              <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="text" name="title" class="form-control" maxlength="20" autocomplete="off" placeholder="Title" required="required">
                  </div>
                </div>
              </div>
              ...
              <!--  <div class="col-sm-6 col-xl-6 col-md-6">
               ...
               <div class="col-sm-6 col-xl-6 col-md-6">
                <div class="mb-12">
                  ...
                  <div class="">
                    <input type="file" name="userfile" class="form-control" autocomplete="off" required="required">
                  </div>
                </div>
              </div>
