...
<script>
  $(function() {
  $('.bodyDimensionModel').click(function(e) {
    e.preventDefault();
    //alert($(this).attr('data-val'));
    $('#bodydimensionid').val($(this).attr('data-val'));
    $('#bodydimensionname').val($(this).attr('data-name'));
    $('#bodydimensiondetails').val($(this).attr('data-details'));
    $('#bodydimensionbikesscootersid').val($(this).attr('data-bikes-scooters'));
