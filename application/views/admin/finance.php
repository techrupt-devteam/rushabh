	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading"> Finance 
					<div class="btn-toolbar pull-right">
	              <div class="btn-group"> 
                  <a href="<?php echo base_url('admin/finance/export');?>" class="btn btn-primary btn-sm pull-right">Download Excel</a>
		              </div>
		        </div>
				</div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr >
                      ...
                      <th class="">Annual Income </th>
                      <th class="">Purchase Time </th>
                      <th class="">Created Date </th>
                    </tr>
                  </thead>
                  <tbody>
                 <?php $cnt=''; foreach($finance_list as $row): $cnt++; ?>
