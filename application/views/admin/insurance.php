	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading"> Insurance 
					<div class="btn-toolbar pull-right">
	              <div class="btn-group"> 
                  <a href="<?php echo base_url('admin/insurance/export');?>" class="btn btn-primary btn-sm pull-right">Download Excel</a>
		              </div>
		        </div>
				</div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr >
                      ...
                      <th class="">For Insurance </th>
                      <th class="">Vehicle Registration </th>
                      <th class="">Created Date  </th>
                    </tr>
                  </thead>
                  <tbody>
                 <?php $cnt=''; foreach($insurance_list as $row): $cnt++; ?>
                  <tr ><!-- data-href="add-party.php" class="cursor-pointer" -->
                   ...
                   <td><?php echo $row['for_insurance']; ?></td>
