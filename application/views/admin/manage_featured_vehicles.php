 ...
 <div class="col-md-12">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Manage Featured Vehicles</li>
    </ol>
  </div>
</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading"> Manage Featured Vehicles
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <strong><a href="<?php echo site_url('admin/manage_featured_vehicles/add');?>" class="btn btn-default pull-right"><i class="la la-plus icon"></i></a></strong>
                  </div>
            </div>
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr >
                      <th >Sr.No</th>
                      <th class="">Title</th>
                      <th class="">Page Link</th>
                      <th class="">Image </th>
                      <th class="">Action </th>
                    </tr>
                  </thead>
                  <tbody>
                 <?php $cnt=''; foreach($featured_vehicles_list as $row): $cnt++; ?>
                  <tr>
                   <td><?php echo $cnt; ?></td>
                   <td><?php echo $row['title']; ?></td>
                   <td><?php echo $row['page_link']; ?></td>
                   <td><img style="width:70px; height:70px;" src="<?php echo base_url(); ?>assets/admin/post_image/featured_vehicles/<?php echo $row['image']; ?>"></td>
