      ...
      <div class="panel panel-default">
        <div class="panel-heading"> System Data
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <strong>
                    <a href="<?php echo base_url('admin/system_data/export');?>" class="btn btn-primary">Download Excel</a>&nbsp;
                    <a href="<?php echo site_url('admin/system_data/add');?>" class="btn btn-info pull-right"><i class="la la-plus icon"></i></a></strong>
                  </div>
            </div>
        </div>
