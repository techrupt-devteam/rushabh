              ...
              <div class="tab-pane active" id="tab_1">
                  ...
                  <div class="row"> 
                   ...
                   <div class="col-md-6">
                      ...
                      <div class="">
                        <input type="file" name="image" class="form-control" autocomplete="off" required="required">
                      </div>
                  </div>
                    ...
                    <p style="text-align: right;width:100%;font-weight:bold;margin-right: 30px;"><a href="javascript:void(0);" onclick="addDocumentRow();">Add Row</a></p>
                    <!--?php } ?-->
                        ...
                        <tbody>
                          ...
                          <?php $cnt=0; foreach($engine as $row): $cnt++; ?>
                            ...
                            <td><?php echo $row['list']; ?> 
                                <input type="text" name="id[]" value="<?php echo $bikes_scooters['id']; ?>" style="display: none;">
                                <input type="text" name="bikesid[]" value="<?php echo $row['id']; ?>" style="display: none;">
                            </td>
