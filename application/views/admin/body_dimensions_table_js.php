...
function addDocumentRow(){
	...
	var newRow = '<tr id="tbl_document_' + newIdNo + '">' +
		...
		'<td>'+rowsr+'<input type="text" name="id[]" id="id_value_add" style="display: none;"><input type="text" id="type_value" name="type[]" value="Body Dimensions" style="display: none;"></td>' +
		...
		'</td>'+
		/*'<td><a href="javascript:void(0);" onclick="removeDocumentRow(\'tbl_document_' + newIdNo + '\');"><i class="fa fa-trash"></i></a></td>' +*/
