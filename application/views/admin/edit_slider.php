        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-sm-6 col-xl-6 col-md-6">
                ...
                <div class="">
                  <input type="text" name="sort" value="<?php echo $slider_data['sort']; ?>" class="form-control" autocomplete="off" placeholder="Please enter sort order" required="required">
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xl-6 col-md-6">
                ...
                <div class="">
                  <input type="file" name="image" class="form-control" autocomplete="off" placeholder="Please enter email" required="required">
