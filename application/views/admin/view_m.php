 ...
 <div class="col-md-12">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Inbond Calls - Mumbai Naka</li>
    </ol>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="panel panel-default">
        <div class="panel-heading"> Inbond Calls - Mumbai Naka
          <div class="btn-toolbar pull-right">
                <div class="btn-group"> 
                   <strong><a href="<?php echo site_url('admin/inbond_callsm/add_m');?>" class="btn btn-info pull-right"><i class="la la-plus icon"></i></a></strong>
                  </div>
            </div>
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php $cnt=''; foreach($inbond_calls_list as $row): $cnt++; ?>
                  <tr ><!-- data-href="add-party.php" class="cursor-pointer" -->
                   ...
                   <td>
                     <a href="<?php echo base_url(); ?>admin/inbond_callsm/view_info/<?php echo $row['id'] ?>"  class="btn btn-default"><i class="la la-table icon"></i></a>
                   <a href="<?php echo base_url(); ?>admin/inbond_callsm/delete/<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this record ?');" class="btn btn-default"><i class="la la-trash icon"></i>
