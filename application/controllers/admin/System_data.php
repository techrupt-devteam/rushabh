...
function __construct(){
    ...
    function export(){
    	...
    	if($from_date){
    	    $data['system_data_list'] = $this->db->query("SELECT * from system_data where created_at between '".$from_date."' and '".$to_date."' order BY id DESC")->result();
    	    $this->load->view('admin/system_data_export',$data);
    	    
    	}else{
    	    $data['system_data_list'] = $this->db->query("SELECT * from system_data order BY id DESC")->result();
    		$this->load->view('admin/system_data_export',$data);
    	}
	}
    ...
    public function view()
	{
		...
		$data['system_data'] = $this->common->getAllRow('system_data','where id='.$id.' ORDER BY id DESC');
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/view_system_data',$data);
		$this->load->view('admin/footer');
