...
class Inbond_callsi extends CI_Controller {
function __construct(){
	...
	public function index()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls','where location="Indira Nagar" ORDER BY id DESC');
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/view_i',$data);
	...
	public function add_i()
	{
		...
		if($this->input->post('submit'))
		{
			...
			if (!empty($_FILES['file']['name'])) {
				...
				else
				{
	                ...
	                $this->inbond_calls->insert_indiranagarData(); 
	            }
		    }
		 ...
		 /*Location Uttam Nagar*/
		    ...
		    /*if($inbond_id)
		    {
			    $filename=$_FILES["file"]["tmp_name"];
			        ...
			        {
			            $sql = $this->db->query("INSERT into inbond_calls_indira_nagar (inbond_id,name,enquiry_no,mobile,source,model,city,contact_to,status,follow_up_date,remarks,created_at) 
			            ...
			            if(!isset($sql))
			            {
							...
							window.location.href = "'.base_url().'admin/inbond_callsi";
							</script>';
			            }
			        }
					fclose($file); 
	    ...
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/add_i',$data);
		$this->load->view('admin/footer');
	}
	...
	public function view_info()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls_indira_nagar','where inbond_id="'.$id.'" && name!="" ');
		
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/viewi_data',$data);
		$this->load->view('admin/footer');
	}
	...
	{ 
		...
		if($delete){
			$this->db->where('inbond_id', $id)->delete('inbond_calls_indira_nagar');	
