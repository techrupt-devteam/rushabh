...
class Inbond_callsu extends CI_Controller {
function __construct(){
	...
	public function index()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls','where location="Uttam Nagar" ORDER BY id DESC');
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/view_u',$data);
	...
	public function add_u()
	{
		...
		if($this->input->post('submit'))
		{
			...
			if (!empty($_FILES['file']['name'])) {
				...
				else
				{
	                ...
	                $this->inbond_calls->insert_uttamnagarData();
	            }
		    }
		    ...
		    /*if($inbond_id)
		    {
			    $filename=$_FILES["file"]["tmp_name"];
			        ...
			        {
			            $sql = $this->db->query("INSERT into inbond_calls_uttam_nagar (inbond_id,name,enquiry_no,mobile,source,model,city,contact_to,status,follow_up_date,remarks,created_at) 
			            ...
			            if(!isset($sql))
			            {
							...
							window.location.href = "'.base_url().'admin/inbond_callsu";
							</script>';
			            }
			        }
					fclose($file); 
	    ...
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/add_u',$data);
		$this->load->view('admin/footer');
	}
	...
	public function view_info()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls_uttam_nagar','where inbond_id="'.$id.'" && name!= " " ');
	...
	{ 
		...
		if($delete){
			$this->db->where('inbond_id', $id)->delete('inbond_calls_uttam_nagar');	
