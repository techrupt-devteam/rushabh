...
class Inbond_callsmh extends CI_Controller {
function __construct(){
	...
	public function index()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls','where location="Mhasrul" ORDER BY id DESC');
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/view_mh',$data);
	...
	public function add_mh()
	{
		...
		if($this->input->post('submit'))
		{
			...
			if (!empty($_FILES['file']['name'])) {
				...
				else
				{
	                ...
	                $this->inbond_calls->insert_mhasrulData();
	            }
		    }
		    ...
		    /*if($inbond_id)
		    {
			    $filename=$_FILES["file"]["tmp_name"];
			        ...
			        {
			            $sql = $this->db->query("INSERT into inbond_calls_mhasrul (inbond_id,name,enquiry_no,mobile,source,model,city,contact_to,status,follow_up_date,remarks,created_at) 
			            ...
			            if(!isset($sql))
			            {
							...
							window.location.href = "'.base_url().'admin/inbond_callsmh";
							</script>';
			            }
			        }
					fclose($file); 
		...
		*/
	    ...
	    $this->load->view('admin/header',$data);
	    $this->load->view('admin/sidebar',$data);                      
		$this->load->view('admin/add_mh',$data);
		$this->load->view('admin/footer');
	}
	...
	public function view_info()
	{
		...
		$data['inbond_calls_list'] = $this->common->getAllRow('inbond_calls_mhasrul','where inbond_id="'.$id.'" && name!=" " ');
	...
	{ 
		...
		if($delete){
			$this->db->where('inbond_id', $id)->delete('inbond_calls_mhasrul');	
